...
const LinkedIn: FunctionComponent<LinkedInProps> = (props: LinkedInProps) => {
	...
	const getUrl = (): string => {
		return `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=${clientId}&scope=${encodeURI("r_emailaddress w_share")}&redirect_uri=${redirectUri}&state=${state}`;
	  }
